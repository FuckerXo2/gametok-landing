    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .thumbnail {
            ...
            border-radius: 24px;
            margin: 0 auto 24px;
            box-shadow: 0 20px 60px rgba(255, 142, 83, 0.3);
            object-fit: cover;
        }
        h1 {
            font-size: 28px;
...
<body>
    <div class="container">
        <img src="${thumbnailUrl}" alt="${gameName}" class="thumbnail" onerror="this.style.display='none'">
